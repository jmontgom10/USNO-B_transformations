...
bounds = [(-0.60, -0.35),   # Theta (angle of the line slope)
          (-0.25, 0.2),    # b_perp (min-dist(line-origin))
...
plt.axis((-5.0, 5.0, -4.8, 2.8))
plt.autoscale(False)

# Plot the slope +/- sigma_intrinsic lines
# Start by including a "typical errorbar"
plt.errorbar(-3.5, -3.8, xerr=data[2], yerr=data[3], color='k')
